...
public class Main {
    ...
    public void run() {
        ...
        AdopterService adopterService = context.getBean("personService", AdopterService.class);

        Adopter person1 = new AdopterImpl("Edwin Soto", "843-123-7981", "edwin.soto@email.com", true);
